...
def rank_candidates(jd_text, uploaded_files, semantic_weight=0.6, skill_weight=0.4):
    ...
    for file in uploaded_files:
        ...
        final_score = round(semantic_weight * semantic_score + skill_weight * skill_match_pct, 2)
